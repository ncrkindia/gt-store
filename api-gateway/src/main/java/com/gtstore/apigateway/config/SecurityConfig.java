    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.DELETE, "/api/products/**").hasRole("GTS_ADMIN")

                        .pathMatchers(HttpMethod.POST, "/api/categories/**").hasRole("GTS_ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/api/categories/**").hasRole("GTS_ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/api/categories/**").hasRole("GTS_ADMIN")

                        .pathMatchers(HttpMethod.GET, "/api/orders/all").hasRole("GTS_ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/api/orders/*/status").hasRole("GTS_ADMIN")
